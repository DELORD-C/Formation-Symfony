 ...
 */
final class Version20231004142604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, user_id, subject, body, created_at FROM post');
        ...
        $this->addSql('INSERT INTO post (id, user_id, subject, body, created_at) SELECT id, user_id, subject, body, created_at FROM __temp__post');
